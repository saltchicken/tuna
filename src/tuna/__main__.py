...
def main():
    ...
    parser.add_argument("--model", type=str, default="unsloth/llama-3-8b-Instruct-bnb-4bit", help="Model name to use for training. Default is model_name='unsloth/llama-3-8b-bnb-4bit'")
    parser.add_argument("--max_steps", type=int, default=30, help="Max training steps. Default is max_steps=30")
    parser.add_argument("--dataset", type=str, default="virattt/financial-qa-10k", help="Dataset to use for training. Default is dataset='vicgalle/alpaca-gpt4'")
